...
template <> constexpr inline auto SettingsPage::qt_create_metaobjectdata<qt_meta_tag_ZN12SettingsPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'settingsSubmitted'
        QtMocHelpers::SignalData<void(const AppSettings &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void SettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->settingsSubmitted((*reinterpret_cast<std::add_pointer_t<AppSettings>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsPage::*)(const AppSettings & )>(_a, &SettingsPage::settingsSubmitted, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsPage::settingsSubmitted(const AppSettings & _t1)
{
